// Express application — used by both:
//   - server/index.js (local dev: `app.listen(PORT)`)
//   - api/index.js     (Vercel: a single serverless function fronts all /api/*)
// Adding a new route: define it here once, mount or use directly. There's no
// per-route Vercel file to keep in sync anymore.
